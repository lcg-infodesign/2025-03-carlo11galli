...
function draw() {
  ...
  let closestDist = Infinity; // inizializza la distanza minima trovata con un valore molto grande
  let closestRow = null;
...
function drawLegend() {
  ...
  for (let i = 0; i <= gradH; i++) { // piccoli segmenti con incremento colore
    let inter = i / gradH; // colore da 0 a 1
    let c = lerpColor(color(150, 255, 150), color(0, 0, 150), inter); // se inter=0 colore1, se =1 colore2
    stroke(c);
